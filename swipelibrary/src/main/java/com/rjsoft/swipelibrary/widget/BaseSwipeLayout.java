    ...
    private void init() {
        mViewDragHelper = ViewDragHelper.create(this, 1.0f, new ViewDragHelper.Callback() {
            ...
            public int clampViewPositionHorizontal(View child, int left, int dx) {
                ...
                if (mCurEdgeFlag == ViewDragHelper.EDGE_LEFT || mCurEdgeFlag == ViewDragHelper.EDGE_RIGHT) {
                    return left;
                } else {
                    return 0;
                }
            ...
            public int clampViewPositionVertical(View child, int top, int dy) {
                ...
                if (mCurEdgeFlag == ViewDragHelper.EDGE_TOP || mCurEdgeFlag == ViewDragHelper.EDGE_BOTTOM) {
                    return top;
                }else return 0;
            }
