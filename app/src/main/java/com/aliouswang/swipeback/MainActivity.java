...
public class MainActivity extends AppCompatActivity {
    ...
    private Button btn_comon_view_drag_helper;
    ...
    private void initView() {
        ...
        btn_comon_view_drag_helper = (Button) findViewById(R.id.btn_comon_view_drag_helper);
        btn_comon_view_drag_helper.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity.this, CommonSwipeActivity.class);
                startActivity(intent);
            }
        });
